<%@ Page Title="" Language="C#" MasterPageFile="~/Job.Master" AutoEventWireup="true" CodeBehind="jobsingle.aspx.cs" Inherits="JobHunting.joblist" %>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="jobboard/images/job_single_img_1.jpg" alt="Image" class="img-fluid rounded"></figure>
      ...
      <div class="container">
        ...
        <ul class="job-listings mb-5">
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.aspx"></a>
            <div class="job-listing-logo">
              <img src="jobboard/images/job_logo_1.jpg" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.aspx"></a>
            <div class="job-listing-logo">
              <img src="jobboard/images/job_logo_2.jpg" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.aspx"></a>
            <div class="job-listing-logo">
              <img src="jobboard/images/job_logo_3.jpg" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.aspx"></a>
            <div class="job-listing-logo">
              <img src="jobboard/images/job_logo_4.jpg" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.aspx"></a>
            <div class="job-listing-logo">
              <img src="jobboard/images/job_logo_5.jpg" alt="Image" class="img-fluid">
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 ml-auto align-self-end">
            <img src="jobboard/images/apps.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>

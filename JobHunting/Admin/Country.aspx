<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="Country.aspx.cs" Inherits="JobHunting.Admin.Country" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left">Country Form </h4>
                ...
                <div class="col-12">
                    <form id="fc" runat="server">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="card-box">
                                    <%--<h4 class="m-t-0 m-b-30 header-title">Country Form</h4>--%>
                                    <div class="form-group">
                                        <label>Country Name</label>
                                        <input type="text" class="form-control" id="txtCountryName" runat="server" placeholder="Enter Country Name">
                                    </div>
                            ...
                            <div class="col-sm-8">
                                <div class="card-box table-responsive">
                                    <table class="table table-striped add-edit-table" id="datatable-editable" style="width: 100%">
                                        ...
                                        <tbody>
                                            <% foreach (var res in GetAllCountry())
                                                { %>
                                            <tr>
                                                <td class="coid"><%=res.CountryID %></td>
                                                <td class="coname"><%=res.CountryName%></td>
                                                <td class="actions">
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptarea" runat="server">
    <script>
        function ShowData(ele) {
            ...
            var countryid = eleList[0].innerHTML;
            var countryname = eleList[1].innerHTML;

            $('[id$=hfCOID]').val(countryid);
            $('[id$=txtCountryName]').val(countryname);

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="ProfileAdminPage.aspx.cs" Inherits="JobHunting.Admin.ProfileAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="adminbody" runat="server">
    ...
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="#">MOMIJI</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="profile-bg-picture" style="background-image: url('adminox/default/assets/images/bg-profile.jpg')">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <span class="pull-left m-r-15">
                                    <img src="adminox/default/assets/images/users/avatar-1.jpg" alt="" class="thumb-lg rounded-circle"></span>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="City.aspx.cs" Inherits="JobHunting.Admin.City" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left">City Form </h4>
                            ...
                            <div class="col-5">
                                <div class="card-box">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtCityName" runat="server" placeholder="Enter city Name">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table class="table table-striped add-edit-table" id="datatable-editable" style="width: 100%">
                                        ...
                                        <tbody>
                                            <% foreach (var res in GetAllCity())
                                                { %>
                                            <tr>
                                                <td class="cid"><%=res.CityID %></td>
                                                <td class="cname"><%=res.CityName%></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptarea" runat="server">
    <script>
        function ShowData(ele) {
            ...
            var cityid = eleList[0].innerHTML;
            var cityname = eleList[1].innerHTML;
            var countryid = eleList[2].innerHTML;

            $('[id$=hfCID]').val(cityid);
            $('[id$=txtCityName]').val(cityname);
            $('[id$=ddlCountry]').val(countryid);

            // console.log(cityid + " " + cityname + " " + countryid);

                ...
                <div class="col-12">
                    <form id="fc" runat="server">
                        ...
                        <div class="row">
                            ...
                            <asp:HiddenField ID="hfJTID" runat="server" />
                            <div class="col-sm-8">
                                    ...
                                    <table class="table table-striped add-edit-table" id="datatable-editable" style="width: 100%">
                                        ...
                                        <tbody>
                                            <% foreach (var res in GetAllJobType())
                                                { %>
                                            <tr>
                                                <td class="jtid"><%=res.JobTypeID %></td>
                                                <td class="jtname"><%=res.JobTypeName%></td>
                                                <td class="actions">
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptarea" runat="server">
    <script>
        function ShowData(ele) {
            ...
            var jobtypeid = eleList[0].innerHTML;
            var jobtypename = eleList[1].innerHTML;

            $('[id$=hfJTID]').val(jobtypeid);
            $('[id$=txtJobTypeName]').val(jobtypename);
